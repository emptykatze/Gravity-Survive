...
planeta1 = pygame.image.load("imagenes/planets/19.png").convert_alpha()
planeta1=pygame.transform.scale(planeta1,(int(tamañoplaneta/2+2),int(tamañoplaneta/2)))

planeta2 = pygame.image.load("imagenes/planets/7.png").convert_alpha()
planeta2=pygame.transform.scale(planeta2,(int(tamañoplaneta/2+12),int(tamañoplaneta/2+10)))

planeta3 = pygame.image.load("imagenes/planets/2.png").convert_alpha()
